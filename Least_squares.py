...
# === Step 1: 读取 CSV 文件 ===
df_e1 = pd.read_csv(r"C:\UltraLight-VMUNet-Output\DDR_Output\merged-E1.csv")
df_e2 = pd.read_csv(r"C:\UltraLight-VMUNet-Output\DDR_Output\merged-E2.csv")
df_e3 = pd.read_csv(r"C:\UltraLight-VMUNet-Output\DDR_Output\merged-E3.csv")
df_label = pd.read_csv(r"C:\UltraLight-VMUNet-Output\DDR_Output\labeled.csv")
